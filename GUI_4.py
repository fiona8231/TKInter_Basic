...
Button(root, text="Submit").grid(row=0, column=7 )

# Radio button

Label(root, text="Radio button").grid(row=1, column=0, sticky=W)
Radiobutton(root, text="New", value=1).grid(row=2, column=0, stick=W)
